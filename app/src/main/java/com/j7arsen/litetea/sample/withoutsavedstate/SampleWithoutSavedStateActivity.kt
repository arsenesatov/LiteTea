...
class SampleWithoutSavedStateActivity : AppCompatActivity() {

    private val viewModel: SampleWithoutSavedStateViewModel by viewModels { SampleWithoutSavedStateViewModelFactory() }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnShowRandomMessage.setOnClickListener {
            viewModel.accept(SampleWithoutSavedStateMsg.GenerateAndShowRandomMessage)
        }
